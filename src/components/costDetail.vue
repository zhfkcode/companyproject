        ...
        <ul class="filter-box">
            ...
            <li>
                <label class="mr_10">时间</label>
                 <DatePicker v-model="date" type="daterange" placement="bottom-end" placeholder="Select date" style="width: 200px"></DatePicker>
            </li>
            <li>
...
export default {
  ...
  mounted(){
      let mock = [{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'},{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'},{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'},{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'},{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'},{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'},{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'},{acc:'1888655565',total: 555, record: '黑号查询', date: '2016-10-12 12:20:35'}]
      this.costList = mock
  },
   methods:{
    search(){ //搜索查询
